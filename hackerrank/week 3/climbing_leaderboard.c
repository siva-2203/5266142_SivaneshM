 ...
 *
 */
long long remove_duplicates(int arr[],int n)
{
    long long i=0;
...
int* climbingLeaderboard(int ranked_count, int* ranked, int player_count, int* player, int* result_count) {
    long long x=remove_duplicates(ranked,ranked_count);
    int* res=malloc(sizeof(int)*player_count);
    //int i=0;
    for(long long j=0;j<player_count;j++)
    {
        int pos=bin_search(ranked,x,player[j]);
        /*long long i=x-1;
